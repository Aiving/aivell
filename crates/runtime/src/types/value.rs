...
use super::native_function::KAsyncNativeFunction;
...
pub enum KValue {
    ...
    /// A async function that's implemented outside of the Koto runtime
    AsyncNativeFunction(KAsyncNativeFunction),
...
impl KValue {
    ...
    pub fn type_as_string(&self) -> KString {
        ...
        match &self {
            ...
            Function(_) | CaptureFunction(_) | NativeFunction(_) | AsyncNativeFunction(_) => {
